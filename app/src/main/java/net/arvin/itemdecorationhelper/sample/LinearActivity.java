...
import net.arvin.itemdecorationhelper.StickyDividerCallback;
...
public class LinearActivity extends AppCompatActivity {
    ...
    private WeakHashMap<Integer, View> viewWeakHashMap = new WeakHashMap<>();//每一项对应的headerView
            ...
            itemDecoration = new ItemDecorationFactory.StickyDividerBuilder()
                    ...
                    .callback(new StickyDividerCallback() {
                        ...
                        public View getStickyHeaderView(int position) {
                            View headerView = viewWeakHashMap.get(position);
                            if (headerView == null) {
                                headerView = LayoutInflater.from(LinearActivity.this).inflate(R.layout.layout_section_header, null);
                                TextView tvSection = headerView.findViewById(R.id.tv_section);
                                tvSection.setText(items.get(position).getLetter());
                                viewWeakHashMap.put(position, headerView);
                            }
                            return headerView;
                        }
                    }).build(recyclerView);
